...
export const HOME_SERVICES: HomeServiceCard[] = [
  ...
  {
    title: "Planos Arquitectónicos",
    body: "Planos listos para permiso para proyectos residenciales y comerciales — dibujados para presentarse, no solo para admirarse.",
    points: [
      "Plantas",
      "Elevaciones",
      "Secciones",
  ...
  {
    title: "Planos Estructurales",
    body: "Diseño de cimentación, estructura y refuerzo — seguro, estable y conforme a los códigos de construcción locales.",
    points: [
  ...
  {
    title: "Planos Civiles",
    body: "Planos de lote, nivelación, drenaje, servicios y control de erosión que cumplen con el condado.",
    points: [
      "Linderos y retiros",
  ...
  },
  {
    ...
    body: "Supervisamos la planeación, estimación de costos, programación, control de calidad e inspecciones — de principio a fin.",
    points: [
  ...
  {
    title: "Renders",
    body: "Imágenes 3D fotorrealistas que permiten a clientes, inversionistas y compradores ver el proyecto antes de que exista.",
    points: [
      "Renders exteriores",
      "Renders interiores",
      "Vistas de lote y aéreas",
  ...
  {
    title: "Estudios de Reserva",
    body: "Estudios de reserva para asociaciones de propietarios (HOA) y de condominios — inventario de componentes, evaluación de condición y un plan de fondeo a largo plazo.",
    points: [
      "Inventario de componentes",
      "Evaluación de condición",
      "Plan de fondeo a 30 años",
      "Informe listo para cumplimiento",
    ],
    href: "/contact",
    icon: Calculator,
  },
