...
export const PHILOSOPHY =
  "We recognise that building a home is a monumental investment. Our job is to deliver innovative solutions in an ever-evolving AEC industry, so that investment is protected by drawings that are correct the first time.";
...
export const TESTIMONIALS = [
  {
    quote:
      "Builders Tech provided property layout design. They were very responsive and explained the process and delivered in tone.",
