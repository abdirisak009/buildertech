...
export const INTERNSHIPS = {
  ...
  body: [
    "Builders Tech runs an internship programme aimed at opening the AEC industry to young people in DeKalb County and the wider Atlanta area — students who can draw, measure, estimate and manage, but have never been shown a way in.",
