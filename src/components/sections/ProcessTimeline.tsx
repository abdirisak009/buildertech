...
function ProcessStep({
  ...
  return (
    <li>
      <Reveal>
        <div className="grid grid-cols-[3rem_1fr] gap-x-5 gap-y-5 pb-10 last:pb-0 sm:gap-x-6">
          ...
          <div className="grid gap-6 pt-1.5 lg:grid-cols-2 lg:items-start lg:gap-10">
            <div>
