...
export const en = {
  ...
  form: {
    ...
    errors: {
      ...
      referral: "Please select where you heard about us.",
    ...
    services: [
      "Full Service (Architectural, Structural, MEP, Civil)",
      "Architectural Plans",
      "Structural Plans",
      "Civil Site Plans",
      "Stop Work Order",
